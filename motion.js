(() => {
  ...
  if('IntersectionObserver' in window){
    ...
    document.querySelectorAll('.content-section>.section-label,.about-layout,.about-avatar,.skills-layout,.experience-item,.project-card,.education-card,.contact-layout').forEach(el=>{el.classList.add('reveal');observer.observe(el)});
